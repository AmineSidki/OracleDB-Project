-- ============================================================
-- Site1 Fragment Schema
-- Scenario 1 fragment: idcateg=50 AND quantite>100
-- ============================================================

ALTER SESSION SET CONTAINER = XEPDB1;

CREATE USER site1 IDENTIFIED BY site1123
...
-- ------------------------------------------------------------
-- Fragment tables (mirror structure of global EShop schema)
-- ------------------------------------------------------------
...
CREATE TABLE Produits1 (
    ...
    CONSTRAINT fk_p1_categ FOREIGN KEY (idcateg)
        REFERENCES Categories1(idcateg)
);
